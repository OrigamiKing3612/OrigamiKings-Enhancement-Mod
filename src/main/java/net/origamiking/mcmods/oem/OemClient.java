...
public class OemClient implements ClientModInitializer {
   ...
   public void onInitializeClient() {
      ...
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_COPPER_BARS, RenderLayer.getTranslucent());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_EXPOSED_COPPER_BARS, RenderLayer.getTranslucent());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_WEATHERED_COPPER_BARS, RenderLayer.getTranslucent());
      ...
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_COPPER_DOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_COPPER_TRAPDOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_EXPOSED_COPPER_DOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_EXPOSED_COPPER_TRAPDOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_WEATHERED_COPPER_DOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_WEATHERED_COPPER_TRAPDOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_OXIDIZED_COPPER_DOOR, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_OXIDIZED_COPPER_TRAPDOOR, RenderLayer.getCutout());
      ...
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_COPPER_CHAIN, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_WEATHERED_COPPER_CHAIN, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_EXPOSED_COPPER_CHAIN, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(WaxedCopperBlocks.WAXED_OXIDIZED_COPPER_CHAIN, RenderLayer.getCutout());
      ...
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.OAK_LEAVES_CARPET, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.SPRUCE_LEAVES_CARPET, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.BIRCH_LEAVES_CARPET, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.ACACIA_LEAVES_CARPET, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.JUNGLE_LEAVES_CARPET, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.DARK_OAK_LEAVES_CARPET, RenderLayer.getCutout());
      BlockRenderLayerMap.INSTANCE.putBlock(LeafCarpets.MANGROVE_LEAVES_CARPET, RenderLayer.getCutout());
