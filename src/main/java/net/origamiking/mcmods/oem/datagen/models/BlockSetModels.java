...
public class BlockSetModels {
    public static void get(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockSet(blockStateModelGenerator, Blocks.ACACIA_LOG, AcaciaWoodBlocks.ACACIA_LOG_SLAB, AcaciaWoodBlocks.ACACIA_LOG_STAIRS);
        blockSet(blockStateModelGenerator, AzaleaWoodBlocks.AZALEA_LOG, AzaleaWoodBlocks.AZALEA_LOG_SLAB, AzaleaWoodBlocks.AZALEA_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.BIRCH_LOG, BirchWoodBlocks.BIRCH_LOG_SLAB, BirchWoodBlocks.BIRCH_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.CRIMSON_STEM, CrimsonWoodBlocks.CRIMSON_LOG_SLAB, CrimsonWoodBlocks.CRIMSON_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.DARK_OAK_LOG, DarkOakWoodBlocks.DARK_OAK_LOG_SLAB, DarkOakWoodBlocks.DARK_OAK_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.JUNGLE_LOG, JungleWoodBlocks.JUNGLE_LOG_SLAB, JungleWoodBlocks.JUNGLE_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.MANGROVE_LOG, MangroveWoodBlocks.MANGROVE_LOG_SLAB, MangroveWoodBlocks.MANGROVE_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.OAK_LOG, OakWoodBlocks.OAK_LOG_SLAB, OakWoodBlocks.OAK_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.SPRUCE_LOG, SpruceWoodBlocks.SPRUCE_LOG_SLAB, SpruceWoodBlocks.SPRUCE_LOG_STAIRS);
        blockSet(blockStateModelGenerator, Blocks.WARPED_STEM, WarpedWoodBlocks.WARPED_LOG_SLAB, WarpedWoodBlocks.WARPED_LOG_STAIRS);
    }
}
