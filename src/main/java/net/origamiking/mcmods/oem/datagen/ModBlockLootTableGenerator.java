...
public class ModBlockLootTableGenerator extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(BarrelBlocks.OAK_BARREL);
        addDrop(LadderBlocks.OAK_LADDER);
        addDrop(BarrelBlocks.SPRUCE_BARREL);
        addDrop(LadderBlocks.SPRUCE_LADDER);
        addDrop(BookshelfBlocks.SPRUCE_BOOKSHELF);
        addDrop(LadderBlocks.BIRCH_LADDER);
        addDrop(BarrelBlocks.BIRCH_BARREL);
        addDrop(BookshelfBlocks.BIRCH_BOOKSHELF);
        addDrop(LadderBlocks.JUNGLE_LADDER);
        addDrop(BookshelfBlocks.JUNGLE_BOOKSHELF);
        addDrop(BarrelBlocks.JUNGLE_BARREL);
        addDrop(LadderBlocks.ACACIA_LADDER);
        addDrop(BookshelfBlocks.ACACIA_BOOKSHELF);
        addDrop(BarrelBlocks.ACACIA_BARREL);
        addDrop(LadderBlocks.DARK_OAK_LADDER);
        addDrop(BookshelfBlocks.DARK_OAK_BOOKSHELF);
        addDrop(BarrelBlocks.DARK_OAK_BARREL);
        addDrop(LadderBlocks.MANGROVE_LADDER);
        addDrop(BarrelBlocks.MANGROVE_BARREL);
        addDrop(BookshelfBlocks.MANGROVE_BOOKSHELF);
        addDrop(LadderBlocks.CRIMSON_LADDER);
        addDrop(BarrelBlocks.CRIMSON_BARREL);
        addDrop(BookshelfBlocks.CRIMSON_BOOKSHELF);
        addDrop(LadderBlocks.WARPED_LADDER);
        addDrop(BarrelBlocks.WARPED_BARREL);
        addDrop(BookshelfBlocks.WARPED_BOOKSHELF);
