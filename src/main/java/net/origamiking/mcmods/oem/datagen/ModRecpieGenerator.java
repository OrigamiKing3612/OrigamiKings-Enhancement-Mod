...
//                .offerTo(exporter, new Identifier(RecipeProvider.getRecipeName(GoldBlocks.GOLD_BARS)));
    ...
    public static void stairs() {
        ...
        createWallRecipe(AmethystBlocks.AMETHYST_WALL, Ingredient.ofItems(Blocks.AMETHYST_BLOCK));
        createWallRecipe(RandomBlocks.CALSITE_WALL, Ingredient.ofItems(Blocks.CALCITE));
        createWallRecipe(RandomBlocks.TUFF_WALL, Ingredient.ofItems(Blocks.TUFF));
        createWallRecipe(RandomBlocks.SMOOTH_BASALT_WALL, Ingredient.ofItems(Blocks.SMOOTH_BASALT));
        createWallRecipe(RandomBlocks.NETHERRACK_WALL, Ingredient.ofItems(Blocks.NETHERRACK));
        createWallRecipe(RandomBlocks.DRIPSTONE_WALL, Ingredient.ofItems(Blocks.DRIPSTONE_BLOCK));
        createWallRecipe(RandomBlocks.SNOW_WALL, Ingredient.ofItems(Blocks.SNOW_BLOCK));
        ...
        createBarRecipe(CopperBlocks.COPPER_BARS, Ingredient.ofItems(Blocks.COPPER_BLOCK));
        createBarRecipe(CopperBlocks.EXPOSED_COPPER_BARS, Ingredient.ofItems(Blocks.EXPOSED_COPPER));
        createBarRecipe(CopperBlocks.WEATHERED_COPPER_BARS, Ingredient.ofItems(Blocks.WEATHERED_COPPER));
        createBarRecipe(CopperBlocks.OXIDIZED_COPPER_BARS, Ingredient.ofItems(Blocks.OXIDIZED_COPPER));
        ...
        RecipeProvider.createStairsRecipe(CopperBlocks.COPPER_BUTTON, Ingredient.ofItems(Blocks.COPPER_BLOCK));
        RecipeProvider.createStairsRecipe(CopperBlocks.EXPOSED_COPPER_BUTTON, Ingredient.ofItems(Blocks.EXPOSED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.WEATHERED_COPPER_BUTTON, Ingredient.ofItems(Blocks.WEATHERED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.OXIDIZED_COPPER_BUTTON, Ingredient.ofItems(Blocks.OXIDIZED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.COPPER_DOOR, Ingredient.ofItems(Blocks.COPPER_BLOCK));
        RecipeProvider.createStairsRecipe(CopperBlocks.COPPER_TRAPDOOR, Ingredient.ofItems(Blocks.COPPER_BLOCK));
        ...
        createWallRecipe(WhiteWool.WHITE_WOOL_WALL, Ingredient.ofItems(Blocks.WHITE_WOOL));
        ...
        createWallRecipe(LightGrayWool.LIGHT_GRAY_WOOL_WALL, Ingredient.ofItems(Blocks.LIGHT_GRAY_WOOL));
        ...
        createWallRecipe(GrayWool.GRAY_WOOL_WALL, Ingredient.ofItems(Blocks.GRAY_WOOL));
        ...
        createWallRecipe(BlackWool.BLACK_WOOL_WALL, Ingredient.ofItems(Blocks.BLACK_WOOL));
        ...
        createWallRecipe(BrownWool.BROWN_WOOL_WALL, Ingredient.ofItems(Blocks.BROWN_WOOL));
        ...
        createWallRecipe(RedWool.RED_WOOL_WALL, Ingredient.ofItems(Blocks.RED_WOOL));
        ...
        createWallRecipe(OrangeWool.ORANGE_WOOL_WALL, Ingredient.ofItems(Blocks.ORANGE_WOOL));
        ...
        createWallRecipe(YellowWool.YELLOW_WOOL_WALL, Ingredient.ofItems(Blocks.YELLOW_WOOL));
        ...
        createWallRecipe(LimeWool.LIME_WOOL_WALL, Ingredient.ofItems(Blocks.LIME_WOOL));
        ...
        createWallRecipe(GreenWool.GREEN_WOOL_WALL, Ingredient.ofItems(Blocks.GREEN_WOOL));
        ...
        createWallRecipe(CyanWool.CYAN_WOOL_WALL, Ingredient.ofItems(Blocks.CYAN_WOOL));
        ...
        createWallRecipe(LightBlueWool.LIGHT_BLUE_WOOL_WALL, Ingredient.ofItems(Blocks.LIGHT_BLUE_WOOL));
        ...
        createWallRecipe(BlueWool.BLUE_WOOL_WALL, Ingredient.ofItems(Blocks.BLUE_WOOL));
        ...
        createWallRecipe(PurpleWool.PURPLE_WOOL_WALL, Ingredient.ofItems(Blocks.PURPLE_WOOL));
        ...
        createWallRecipe(MagentaWool.MAGENTA_WOOL_WALL, Ingredient.ofItems(Blocks.MAGENTA_WOOL));
        ...
        createWallRecipe(PinkWool.PINK_WOOL_WALL, Ingredient.ofItems(Blocks.PINK_WOOL));
        ...
        createWallRecipe(LeafWalls.OAK_LEAVES_WALL, Ingredient.ofItems(Blocks.OAK_LEAVES));
        createWallRecipe(LeafWalls.SPRUCE_LEAVES_WALL, Ingredient.ofItems(Blocks.SPRUCE_LEAVES));
        createWallRecipe(LeafWalls.BIRCH_LEAVES_WALL, Ingredient.ofItems(Blocks.BIRCH_LEAVES));
        createWallRecipe(LeafWalls.JUNGLE_LEAVES_WALL, Ingredient.ofItems(Blocks.JUNGLE_LEAVES));
        createWallRecipe(LeafWalls.ACACIA_LEAVES_WALL, Ingredient.ofItems(Blocks.ACACIA_LEAVES));
        createWallRecipe(LeafWalls.DARK_OAK_LEAVES_WALL, Ingredient.ofItems(Blocks.DARK_OAK_LEAVES));
        createWallRecipe(LeafWalls.MANGROVE_LEAVES_WALL, Ingredient.ofItems(Blocks.MANGROVE_LEAVES));
        RecipeProvider.createStairsRecipe(CopperBlocks.EXPOSED_COPPER_DOOR, Ingredient.ofItems(Blocks.EXPOSED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.EXPOSED_COPPER_TRAPDOOR, Ingredient.ofItems(Blocks.EXPOSED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.WEATHERED_COPPER_DOOR, Ingredient.ofItems(Blocks.WEATHERED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.WEATHERED_COPPER_TRAPDOOR, Ingredient.ofItems(Blocks.WEATHERED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.OXIDIZED_COPPER_DOOR, Ingredient.ofItems(Blocks.OXIDIZED_COPPER));
        RecipeProvider.createStairsRecipe(CopperBlocks.OXIDIZED_COPPER_TRAPDOOR, Ingredient.ofItems(Blocks.OXIDIZED_COPPER));
        createWallRecipe(ConcreteWalls.WHITE_CONCRETE_WALL, Ingredient.ofItems(Blocks.WHITE_CONCRETE));
        createWallRecipe(ConcreteWalls.LIGHT_GRAY_CONCRETE_WALL, Ingredient.ofItems(Blocks.LIGHT_GRAY_CONCRETE));
        createWallRecipe(ConcreteWalls.GRAY_CONCRETE_WALL, Ingredient.ofItems(Blocks.GRAY_CONCRETE));
        createWallRecipe(ConcreteWalls.BLACK_CONCRETE_WALL, Ingredient.ofItems(Blocks.BLACK_CONCRETE));
        createWallRecipe(ConcreteWalls.BROWN_CONCRETE_WALL, Ingredient.ofItems(Blocks.BROWN_CONCRETE));
        createWallRecipe(ConcreteWalls.RED_CONCRETE_WALL, Ingredient.ofItems(Blocks.RED_CONCRETE));
        createWallRecipe(ConcreteWalls.ORANGE_CONCRETE_WALL, Ingredient.ofItems(Blocks.ORANGE_CONCRETE));
        createWallRecipe(ConcreteWalls.YELLOW_CONCRETE_WALL, Ingredient.ofItems(Blocks.YELLOW_CONCRETE));
        createWallRecipe(ConcreteWalls.LIME_CONCRETE_WALL, Ingredient.ofItems(Blocks.LIME_CONCRETE));
        createWallRecipe(ConcreteWalls.GREEN_CONCRETE_WALL, Ingredient.ofItems(Blocks.GREEN_CONCRETE));
        createWallRecipe(ConcreteWalls.CYAN_CONCRETE_WALL, Ingredient.ofItems(Blocks.CYAN_CONCRETE));
        createWallRecipe(ConcreteWalls.LIGHT_BLUE_CONCRETE_WALL, Ingredient.ofItems(Blocks.LIGHT_BLUE_CONCRETE));
        createWallRecipe(ConcreteWalls.BLUE_CONCRETE_WALL, Ingredient.ofItems(Blocks.BLUE_CONCRETE));
        createWallRecipe(ConcreteWalls.PURPLE_CONCRETE_WALL, Ingredient.ofItems(Blocks.PURPLE_CONCRETE));
        createWallRecipe(ConcreteWalls.MAGENTA_CONCRETE_WALL, Ingredient.ofItems(Blocks.MAGENTA_CONCRETE));
        createWallRecipe(ConcreteWalls.PINK_CONCRETE_WALL, Ingredient.ofItems(Blocks.PINK_CONCRETE));
        createWallRecipe(SculkBlocks.SCULK_WALL, Ingredient.ofItems(Blocks.SCULK));
        RecipeProvider.createStairsRecipe(StoneVSlabs.STONE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.STONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.COBBLESTONE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.COBBLESTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_MOSSY_COBBLESTONE_SLAB, Ingredient.ofItems(Blocks.MOSSY_COBBLESTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_SMOOTH_STONE_SLAB, Ingredient.ofItems(Blocks.SMOOTH_STONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_STONE_BRICK_SLAB, Ingredient.ofItems(Blocks.STONE_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_MOSSY_STONE_BRICK_SLAB, Ingredient.ofItems(Blocks.MOSSY_STONE_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_GRANITE_SLAB, Ingredient.ofItems(Blocks.GRANITE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_POLISHED_GRANITE_SLAB, Ingredient.ofItems(Blocks.POLISHED_GRANITE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_DIORITE_SLAB, Ingredient.ofItems(Blocks.DIORITE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_POLISHED_DIORITE_SLAB, Ingredient.ofItems(Blocks.POLISHED_DIORITE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_ANDESITE_SLAB, Ingredient.ofItems(Blocks.ANDESITE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_POLISHED_ANDESITE_SLAB, Ingredient.ofItems(Blocks.POLISHED_ANDESITE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_COBBLED_DEEPSLATE_SLAB, Ingredient.ofItems(Blocks.COBBLED_DEEPSLATE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_POLISHED_DEEPSLATE_SLAB, Ingredient.ofItems(Blocks.POLISHED_DEEPSLATE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_DEEPSLATE_BRICK_SLAB, Ingredient.ofItems(Blocks.DEEPSLATE_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_DEEPSLATE_TILE_SLAB, Ingredient.ofItems(Blocks.DEEPSLATE_TILES));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_BRICK_SLAB, Ingredient.ofItems(Blocks.BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_MUD_BRICK_SLAB, Ingredient.ofItems(Blocks.MUD_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_SANDSTONE_SLAB, Ingredient.ofItems(Blocks.SANDSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_SMOOTH_SANDSTONE_SLAB, Ingredient.ofItems(Blocks.SMOOTH_SANDSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_CUT_SANDSTONE_SLAB, Ingredient.ofItems(Blocks.CUT_SANDSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_RED_SANDSTONE_SLAB, Ingredient.ofItems(Blocks.RED_SANDSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_SMOOTH_RED_SANDSTONE_SLAB, Ingredient.ofItems(Blocks.SMOOTH_RED_SANDSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_CUT_RED_SANDSTONE_SLAB, Ingredient.ofItems(Blocks.CUT_RED_SANDSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_PRISMARINE_SLAB, Ingredient.ofItems(Blocks.PRISMARINE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_PRISMARINE_BRICK_SLAB, Ingredient.ofItems(Blocks.PRISMARINE_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_DARK_PRISMARINE_SLAB, Ingredient.ofItems(Blocks.DARK_PRISMARINE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_NETHER_BRICK_SLAB, Ingredient.ofItems(Blocks.NETHER_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_RED_NETHER_BRICK_SLAB, Ingredient.ofItems(Blocks.RED_NETHER_BRICKS));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_BLACKSTONE_SLAB, Ingredient.ofItems(Blocks.BLACKSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_POLISHED_BLACKSTONE_SLAB, Ingredient.ofItems(Blocks.POLISHED_BLACKSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_POLISHED_BLACKSTONE_BRICK_SLAB, Ingredient.ofItems(Blocks.POLISHED_BLACKSTONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_ENDSTONE_BRICK_SLAB, Ingredient.ofItems(Blocks.END_STONE));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_QUARTZ_SLAB, Ingredient.ofItems(Blocks.QUARTZ_BLOCK));
        RecipeProvider.createStairsRecipe(StoneVSlabs.VERTICAL_SMOOTH_QUARTZ_SLAB, Ingredient.ofItems(Blocks.SMOOTH_QUARTZ));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_OAK_SLAB, Ingredient.ofItems(Blocks.OAK_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_SPRUCE_SLAB, Ingredient.ofItems(Blocks.SPRUCE_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_BIRCH_SLAB, Ingredient.ofItems(Blocks.BIRCH_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_JUNGLE_SLAB, Ingredient.ofItems(Blocks.JUNGLE_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_ACACIA_SLAB, Ingredient.ofItems(Blocks.ACACIA_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_DARK_OAK_SLAB, Ingredient.ofItems(Blocks.DARK_OAK_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_MANGROVE_SLAB, Ingredient.ofItems(Blocks.MANGROVE_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_CRIMSON_SLAB, Ingredient.ofItems(Blocks.CRIMSON_PLANKS));
        RecipeProvider.createStairsRecipe(WoodVSlabs.VERTICAL_WARPED_SLAB, Ingredient.ofItems(Blocks.WARPED_PLANKS));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.WHITE_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.WHITE_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.LIGHT_GRAY_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.LIGHT_GRAY_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.GRAY_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks. GRAY_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.BLACK_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.BLACK_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.BROWN_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.BROWN_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.RED_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.RED_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.ORANGE_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.ORANGE_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.YELLOW_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.YELLOW_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.LIME_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.LIME_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.GREEN_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.GREEN_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.CYAN_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.CYAN_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.LIGHT_BLUE_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.LIGHT_BLUE_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.BLUE_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.BLUE_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.PURPLE_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.PURPLE_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.MAGENTA_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.MAGENTA_CONCRETE));
        RecipeProvider.createStairsRecipe(ConcreteVSlabs.PINK_CONCRETE_VERTICAL_SLAB, Ingredient.ofItems(Blocks.PINK_CONCRETE));
        RecipeProvider.createStairsRecipe(GlassVSlabs.WHITE_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.WHITE_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.LIGHT_GRAY_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.LIGHT_GRAY_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.GRAY_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.GRAY_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.BLACK_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.BLACK_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.BROWN_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.BROWN_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.RED_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.RED_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.ORANGE_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.ORANGE_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.YELLOW_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.YELLOW_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.LIME_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.LIME_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.GREEN_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.GREEN_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.CYAN_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.CYAN_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.LIGHT_BLUE_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.LIGHT_BLUE_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.BLUE_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.BLUE_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.PURPLE_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.PURPLE_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.MAGENTA_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.MAGENTA_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.PINK_GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.PINK_STAINED_GLASS));
        RecipeProvider.createStairsRecipe(GlassVSlabs.GLASS_VERTICAL_SLAB, Ingredient.ofItems(Blocks.GLASS));

    }
    public static CraftingRecipeJsonBuilder createWallRecipe(ItemConvertible output, Ingredient input) {
