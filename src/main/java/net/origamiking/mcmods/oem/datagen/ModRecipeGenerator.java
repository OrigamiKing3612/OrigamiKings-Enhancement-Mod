...
public class ModRecipeGenerator extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
        ...
        offerWallRecipe(exporter, AmethystBlocks.AMETHYST_WALL, Blocks.AMETHYST_BLOCK);
        offerWallRecipe(exporter, RandomBlocks.CALSITE_WALL, Blocks.CALCITE);
        offerWallRecipe(exporter, RandomBlocks.TUFF_WALL, Blocks.TUFF);
        offerWallRecipe(exporter, RandomBlocks.SMOOTH_BASALT_WALL, Blocks.SMOOTH_BASALT);
