...
public class WoodcutterScreenHandler extends ScreenHandler {
    ...
    void populateResult() {
        if (!this.availableRecipes.isEmpty() && this.isInBounds(this.selectedRecipe.get())) {
            WoodcutterRecipe woodcutterRecipe = (WoodcutterRecipe)this.availableRecipes.get(this.selectedRecipe.get());
            this.output.setLastRecipe(woodcutterRecipe);
            this.outputSlot.setStack(woodcutterRecipe.craft(this.input));
        } else {
