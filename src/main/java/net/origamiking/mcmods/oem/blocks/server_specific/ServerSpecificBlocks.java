...
public class ServerSpecificBlocks {
    ...
    public static final Block IRON_BAR_DOOR = registerBlock("iron_bar_door", new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetType.IRON));
    public static final Block GOLD_BAR_DOOR = registerBlock("gold_bar_door", new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetType.IRON));
    public static final Block COPPER_BAR_DOOR = registerBlock("copper_bar_door", new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetType.IRON));
    public static final Block EXPOSED_COPPER_BAR_DOOR = registerBlock("exposed_copper_bar_door", new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetType.IRON));
    public static final Block WEATHERED_COPPER_BAR_DOOR = registerBlock("weathered_copper_bar_door", new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetType.IRON));
    public static final Block OXIDIZED_COPPER_BAR_DOOR = registerBlock("oxidized_copper_bar_door", new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetType.IRON));
