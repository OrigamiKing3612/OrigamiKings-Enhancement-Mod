...
public class CrimsonWoodBlocks {
    ...
    public static final Block CRIMSON_CHEST = registerBlock("crimson_chest", new ChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST), () -> BlockEntityType.CHEST));
    public static final Block CRIMSON_TRAPPED_CHEST = registerBlock("crimson_trapped_chest", new TrappedChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST)));
