...
public class AcaciaWoodBlocks {
    ...
    public static final Block ACACIA_TRAPPED_CHEST = registerBlock("acacia_trapped_chest", new TrappedChestBlock(FabricBlockSettings.copyOf(Blocks.TRAPPED_CHEST)));
