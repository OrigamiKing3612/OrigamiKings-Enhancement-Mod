...
public class RandomBlocks {
    ...
    public static final Block SNOW_SLAB = registerBlock("snow_block_slab", new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(4f).requiresTool().sounds(BlockSoundGroup.SNOW)));
