...
public class WaxedCopperBlocks extends CopperBlocks {
    public static final Block WAXED_COPPER_BARS = registerCopperBlock("waxed_copper_bars", new PaneBlock(OrigamiBlockSettings.of(Material.METAL).requiresTool().strength(4f).nonOpaque().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_EXPOSED_COPPER_BARS = registerCopperBlock("waxed_exposed_copper_bars", new PaneBlock(OrigamiBlockSettings.of(Material.METAL).requiresTool().strength(4f).nonOpaque().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_WEATHERED_COPPER_BARS = registerCopperBlock("waxed_weathered_copper_bars", new PaneBlock(OrigamiBlockSettings.of(Material.METAL).requiresTool().strength(4f).nonOpaque().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_OXIDIZED_COPPER_BARS = registerCopperBlock("waxed_oxidized_copper_bars", new PaneBlock(OrigamiBlockSettings.of(Material.METAL).requiresTool().strength(4f).nonOpaque().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_COPPER_CHAIN = registerCopperBlock("waxed_copper_chain", new ChainBlock(OrigamiBlockSettings.of(Material.METAL).strength(0.4f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_EXPOSED_COPPER_CHAIN = registerCopperBlock("waxed_exposed_copper_chain", new ChainBlock(OrigamiBlockSettings.of(Material.METAL).strength(0.4f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_WEATHERED_COPPER_CHAIN = registerCopperBlock("waxed_weathered_copper_chain", new ChainBlock(OrigamiBlockSettings.of(Material.METAL).strength(0.4f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_OXIDIZED_COPPER_CHAIN = registerCopperBlock("waxed_oxidized_copper_chain", new ChainBlock(OrigamiBlockSettings.of(Material.METAL).strength(0.4f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_COPPER_LANTERN = registerCopperBlock("waxed_copper_lantern", new LanternBlock(OrigamiBlockSettings.of(Material.METAL).luminance(8).strength(0.2f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_EXPOSED_COPPER_LANTERN = registerCopperBlock("waxed_exposed_copper_lantern", new LanternBlock(OrigamiBlockSettings.of(Material.METAL).luminance(8).strength(0.2f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_WEATHERED_COPPER_LANTERN = registerCopperBlock("waxed_weathered_copper_lantern", new LanternBlock(OrigamiBlockSettings.of(Material.METAL).luminance(8).strength(0.2f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block WAXED_OXIDIZED_COPPER_LANTERN = registerCopperBlock("waxed_oxidized_copper_lantern", new LanternBlock(OrigamiBlockSettings.of(Material.METAL).luminance(8).strength(0.2f).requiresTool().sounds(BlockSoundGroup.COPPER)));
