...
public class SpruceWoodBlocks {
    ...
    public static final Block SPRUCE_CHEST = registerBlock("spruce_chest", new ChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST), () -> BlockEntityType.CHEST));
    public static final Block SPRUCE_TRAPPED_CHEST = registerBlock("spruce_trapped_chest", new TrappedChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST)));
