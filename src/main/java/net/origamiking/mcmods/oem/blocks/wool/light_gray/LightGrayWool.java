...
public class LightGrayWool extends BlocksUtils {
    public static final Block LIGHT_GRAY_WOOL_STAIRS = registerBlock(OemMain.MOD_ID, "light_gray_wool_stairs", new StairsBlock(Blocks.LIGHT_GRAY_WOOL.getDefaultState(), OrigamiBlockSettings.create().strength(0.8f).requiresTool().sounds(BlockSoundGroup.WOOL)));
