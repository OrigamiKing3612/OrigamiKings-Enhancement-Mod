...
public class SculkBlocks {
    ...
    public static final Block SCULK_WALL = registerBlock(id, "sculk_wall", new WallBlock(OrigamiBlockSettings.of(Material.SCULK).strength(4f).requiresTool().sounds(BlockSoundGroup.SCULK)));
