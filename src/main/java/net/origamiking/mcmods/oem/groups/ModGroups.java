...
public class ModGroups {
    public static final RegistryKey<ItemGroup> OEM_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(OemMain.MOD_ID, "oem_group"));
    public static final RegistryKey<ItemGroup> OEM_V_SLABS = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(OemMain.MOD_ID, "oem_v_slabs"));

    public static void register() {
        OemMain.LOGGER.info("Registering Groups for " + OemMain.VERSION);

        Registry.register(Registries.ITEM_GROUP, OEM_GROUP, FabricItemGroup.builder()
                .icon(() -> new ItemStack(SpruceWoodBlocks.SPRUCE_BARREL))
                .displayName(Text.translatable("oem.group.main_group"))
                .entries((context, entries) -> {
                    ...
                    entries.add(OakWoodBlocks.OAK_LOG_SLAB);
                    entries.add(OakWoodBlocks.OAK_LOG_STAIRS);
                    ...
                    entries.add(SpruceWoodBlocks.SPRUCE_LOG_SLAB);
                    entries.add(SpruceWoodBlocks.SPRUCE_LOG_STAIRS);
                    ...
                    entries.add(BirchWoodBlocks.BIRCH_LOG_SLAB);
                    entries.add(BirchWoodBlocks.BIRCH_LOG_STAIRS);
                    ...
                    entries.add(JungleWoodBlocks.JUNGLE_LOG_SLAB);
                    entries.add(JungleWoodBlocks.JUNGLE_LOG_STAIRS);
                    ...
                    entries.add(AcaciaWoodBlocks.ACACIA_LOG_SLAB);
                    entries.add(AcaciaWoodBlocks.ACACIA_LOG_STAIRS);
                    ...
                    entries.add(DarkOakWoodBlocks.DARK_OAK_LOG_SLAB);
                    entries.add(DarkOakWoodBlocks.DARK_OAK_LOG_STAIRS);
                    ...
                    entries.add(MangroveWoodBlocks.MANGROVE_LOG_SLAB);
                    entries.add(MangroveWoodBlocks.MANGROVE_LOG_STAIRS);
                    ...
                    entries.add(CrimsonWoodBlocks.CRIMSON_LOG_SLAB);
                    entries.add(CrimsonWoodBlocks.CRIMSON_LOG_STAIRS);
                    ...
                    entries.add(WarpedWoodBlocks.WARPED_LOG_SLAB);
                    entries.add(WarpedWoodBlocks.WARPED_LOG_STAIRS);
                    //concrete
                    ...
                    //terracotta
                    entries.add(TerracottaStairs.WHITE_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.WHITE_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.WHITE_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.LIGHT_GRAY_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.LIGHT_GRAY_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.LIGHT_GRAY_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.GRAY_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.GRAY_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.GRAY_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.BLACK_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.BLACK_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.BLACK_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.BROWN_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.BROWN_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.BROWN_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.RED_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.RED_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.RED_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.ORANGE_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.ORANGE_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.ORANGE_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.YELLOW_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.YELLOW_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.YELLOW_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.LIME_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.LIME_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.LIME_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.GREEN_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.GREEN_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.GREEN_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.CYAN_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.CYAN_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.CYAN_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.LIGHT_BLUE_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.LIGHT_BLUE_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.LIGHT_BLUE_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.BLUE_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.BLUE_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.BLUE_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.PURPLE_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.PURPLE_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.PURPLE_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.MAGENTA_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.MAGENTA_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.MAGENTA_TERRACOTTA_WALL);
                    entries.add(TerracottaStairs.PINK_TERRACOTTA_STAIR);
                    entries.add(TerracottaSlabs.PINK_TERRACOTTA_SLAB);
                    entries.add(TerracottaWalls.PINK_TERRACOTTA_WALL);
                    ...
                    entries.add(LeafCarpets.OAK_LEAVES_CARPET);
                    ...
                    entries.add(LeafCarpets.JUNGLE_LEAVES_CARPET);
                    ...
                    entries.add(LeafCarpets.ACACIA_LEAVES_CARPET);
                    ...
                    entries.add(LeafCarpets.DARK_OAK_LEAVES_CARPET);
                    ...
                    entries.add(LeafCarpets.MANGROVE_LEAVES_CARPET);
                    //gold
                    ...
                    entries.add(AzaleaWoodBlocks.AZALEA_LOG_SLAB);
                    entries.add(AzaleaWoodBlocks.AZALEA_LOG_STAIRS);

                }).build());

        Registry.register(Registries.ITEM_GROUP, OEM_V_SLABS, FabricItemGroup.builder()
                .displayName(Text.translatable("oem.group.oem_v_slabs"))
